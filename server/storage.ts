...
export class MemStorage implements IStorage {
  ...
  private initializeCourseData() {
    ...
    const courseData = [
      ...
      { week: 2, day: 4, title: "Say Excuse Me", description: "Practice saying 'excuse me' politely when you need to pass by someone or get their attention. Use a gentle tone and make brief eye contact.", category: "comfort" },
      ...
      { week: 4, day: 2, title: "Ask About Someone's Day", description: "Approach one person and ask 'How has your day been?' or 'How's everything going?' Practice showing genuine interest in their response.", category: "group" },
