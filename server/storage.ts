...
export class MemStorage implements IStorage {
  ...
  private initializeCourseData() {
    ...
    const courseData = [
      ...
      { week: 2, day: 4, title: "Elevator Acknowledgment", description: "If you're in an elevator with others, give a small nod or smile as a greeting. No words necessary.", category: "comfort" },
